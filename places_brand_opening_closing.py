...
chart = alt.Chart(brands_open_close_df).mark_circle(size=40, fill='white', stroke='blue').encode(
...
) + alt.Chart(brands_open_close_df).mark_circle(size=40, fill='white', stroke='red').encode(
